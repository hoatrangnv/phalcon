    ...
    public function addAction()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (!$form->isValid()) {
                ...
                // 
                $category->title_box = $this->request->getPost('title_box');
                $category->category_h2 = $this->request->getPost('category_h2');
                $category->category_h3 = $this->request->getPost('category_h3');
                $category->category_content_2 = Util::filterHtmlTag($this->request->getPost('category_content_2'));
                $category->category_content_3 = Util::filterHtmlTag($this->request->getPost('category_content_3'));
                // 
    ...
    public function tagAddAction()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (!$form->isValid()) {
                ...
                $attribute->name = Util::upperFirstLetter($this->request->getPost('name'));
                // // 
                $attribute->tags_h2 = $this->request->getPost('tags_h2');
                $attribute->tags_h3 = $this->request->getPost('tags_h3');
                $attribute->tags_content_2 = Util::filterHtmlTag($this->request->getPost('tags_content_2'));
                $attribute->tags_content_3 = Util::filterHtmlTag($this->request->getPost('tags_content_3'));
                // // 
                $attribute->slug = Util::slug($this->request->getPost('name'));
                $attribute->ordering = $ordering + 1;
                try {
    ...
    public function tagEditAction()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (!$form->isValid()) {
                ...
                // 
                $tag->tags_h2 = $this->request->getPost('tags_h2');
                $tag->tags_h3 = $this->request->getPost('tags_h3');
                $tag->tags_content_2 = Util::filterHtmlTag($this->request->getPost('tags_content_2'));
                $tag->tags_content_3 = Util::filterHtmlTag($this->request->getPost('tags_content_3'));
                // 
                $tag->updated_at = time();
                try {
                    if (!$tag->update()) {
