...
/** Full URL to the folder that images will be used as library and upload. Include trailing slash and protocol (i.e. http://) */
define('DOMAIN', 'http://admin.intemnhan.com.vn/');

define('MOVE_CDN', 'http://admin.intemnhan.com.vn/file/upload-remote-cdn');
define('LIBRARY_FOLDER_CDN_URL', 'http://cdn.intemnhan.com.vn/asset/home/img/500/');
define('LIBRARY_FOLDER_CDN_150_URL', 'http://cdn.intemnhan.com.vn/asset/home/img/150/');
define('LIBRARY_CURL', 'http://admin.intemnhan.com.vn/ajax/file');
...
/** If resizing, width */
define('RESIZE_WIDTH', 650);
/** If resizing, height */
define('RESIZE_HEIGHT', 650);
