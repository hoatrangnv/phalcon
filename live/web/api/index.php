...
try {
    ...
    $config = new Ini(ROOT . '/app/api/config/parameter.ini');
    ...
    $di->setShared('db', function() use ($config) {
        ...
        if ($debug) {
            $e = new EventsManager();
            $logger = new Logger(ROOT . '/app/api/log/db_master_' . date('Ymd') . '.log');
    ...
    $di->setShared('db_slave', function() use ($config) {
        ...
        if ($debug) {
            $e = new EventsManager();
            $logger = new Logger(ROOT . '/app/api/log/db_slave_' . date('Ymd') . '.log');
    ...
    $di->setShared('router', function() {
        ...
        $routers = new Ini(ROOT . '/app/api/config/router.ini');
    ...
    $di->setShared('dispatcher', function() {
        ...
        $dispatcher->setDefaultNamespace('ITECH\Api\Controller\\');
    ...
    $di->setShared('logger', function() {
        $logger = new Logger(ROOT . '/app/api/log/debug_' . date('Ymd') . '.log');
        return $logger;
    });
    ...
    $application->registerModules(array(
        'api' => array(
            'className' => 'ITECH\Api\Module',
            'path' => ROOT . '/app/api/Module.php'
        ),
        'datasource' => array(
