$(document).ready(function () {
    ...
    $("#search").keyup(function (event) {        
        if (this.value.length > 1) {
            ...
            if (results.length > 0) {
                ...
                $('#gallery-images').append('<center>Không tìm thấy hình ảnh nào.</center>');
            }
    ...
    $("#alt").bind("change input", function () {
        parent.document.getElementById("alt").value = this.value;
    });

    $("#class").bind("change input", function () {
        parent.document.getElementById("class").value = this.value;
    });

    $("#title").bind("change input", function () {
        parent.document.getElementById("title").value = this.value;
    });
