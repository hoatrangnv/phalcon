...
class MuabannhanhComponent extends Component{
    ...
    private $limitdm = array(144,143,178,146,177);
    ...
    public function getByElasticCategory($controller, $theme, $id, $page = 1)
    {
        ...
        $res = $this->searchElastic(array("limit" => '20', "filter_or" => '{"term": {"category.id": '. $id .'}},{"term": {"parent_category.id": '. $id .'}}' ));
        ...
        $argsPagination = array(
            ...
            'total_page' => ($listCompress[$id]['total_item'] / 20) ,
            'url' => $this->url->get(array(
                'for' => 'mbn_list',
                'id'=>$id,
