...
try {
    ...
    $di->setShared('db', function() use ($config) {
        ...
        if ($debug) {
            $e = new EventsManager();
            $logger = new Logger(ROOT . '/app/admin/log/db_master_' . date('Ymd') . '.log');
    ...
    $di->setShared('db_slave', function() use ($config) {
        ...
        if ($debug) {
            $e = new EventsManager();
            $logger = new Logger(ROOT . '/app/admin/log/db_slave_' . date('Ymd') . '.log');
    ...
    $di->setShared('router', function() {
        ...
        $routers = new Ini(ROOT . '/app/admin/config/router.ini');
    ...
    $di->setShared('logger', function() {
        $logger = new Logger(ROOT . '/app/admin/log/debug_' . date('Ymd') . '.log');
        return $logger;
    });
