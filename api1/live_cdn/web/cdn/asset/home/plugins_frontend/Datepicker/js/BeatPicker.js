...
BeatPicker.prototype = {
    dateInputNode: null,
    pickerNode: null,
    daysSimple: "Cn T2 T3 T4 T5 T6 T7".split(" "),
    daysFull: [],
    monthsSimple: "Thg-1 Thg-2 Thg-3 Thg-4 Thg-5 Thg-6 Thg-7 Thg-8 Thg-9 Thg-10 Thg-11 Thg-12".split(" "),
    monthsFull: "Tháng 1 /-Tháng 2 /-Tháng 3 /-Tháng 4 /-Tháng 5 /-Tháng 6 /-Tháng 7 /-Tháng 8 /-Tháng 9 /-Tháng 10 /-Tháng 11 /-Tháng 12".split("-"),
    startDate: new Date,
    ...
    className: {
        ...
        inputTo: "beatpicker-input-to text-input w150",
        betweenRange: "between-range",
        inputFrom: "beatpicker-input-from text-input w150",
        daysCell: "days-cell",
